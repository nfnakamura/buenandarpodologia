...
public class ConsultaLenox 
{
    ...
    public ConsultaLenox() {
    }

    public ConsultaLenox(String Producto, int Cantidad) {
   ...
   {
       String SqlMostrar = "select nomProd, sum(cantidad) from productos where marca = 'Lenox' and fechaVta like '%"+Anio+"-"+Mes+"-%' group by nomProd;";
